###############################################################################
## Train multiple Logistic Regression Model for different data partitions    ##
###############################################################################
# Args:                                                                       #
...
#    col (string): feature that is use to induce partitioning of the data     #
#                                                                             #
# One-hot features:                                                           #
#    -u: user ID one-hot                                                      #
...
# feature that is use to induce partitioning of the data
COL="sm"
...
# Best-LR:
# features="-i -s -icA -icW -scA -scW -tcA -tcW"

python ./src/training/compute_multi_lr.py \
    --dataset=$dataset \
    --num_threads=22 \
    --split_id=0 \
    --col=$COL $features
